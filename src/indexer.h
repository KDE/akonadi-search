...
#ifndef AKONADISEARCH_INDEXER_H_
#define AKONADISEARCH_INDEXER_H_
...
{
public:
    static Indexer *create(const QString &mimeType);

    virtual ~Indexer();

    QByteArray index(const Item &item, const Collection &parent);
